    ...
    public function index(Request $request, string $intrams_id, string $event_id)
{
    ...
    \Log::debug("Raw Challonge matches:", $allMatches);
    ...
    // Sort matches - ensure sorting is done as integer comparison
    $total = $matches->count();
    ...
    // \Log::debug("Sorted matches order:", $sortedMatches->pluck('suggested_play_order')->toArray());
